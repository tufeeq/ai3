...
for(const path of ['/ai/tag/data/live-quotes.json','/ai/tag/data/tagx2-sentinel.json','/ai/tag/data/coverage-rescue.json','/ai/tag/data/sec-catalysts.json','/ai/tag/data/sharia.json','/ai/tag/data/enrichment.json','/ai/tag/data/feed-health.json','/ai3/data/intelligence.json'])assert(src.includes(path),`progress must track required source ${path}`);
