...
function summary(card){
  ...
  return{schemaVersion:1,kind:'TAGX3_VALIDATION_SCORECARD_SUMMARY',generatedAt:card.generatedAt,status:card.status,sessions:card.sessions,snapshotCount:card.snapshotCount,cadence:compactMetric(card.cadence),protocol:card.protocol,horizons,diagnostics:diagnosticsByHorizon,guardrails:{thresholdsChanged:false,edgeClaimed:false,missingOutcomesInterpolated:false,provenanceChangesExcluded:false,singlePointPathsExcluded:false}};
}
