...
Generated: 2026-09-03T14:03:22.770Z
Status: **MEASURING**
Sessions: **5** · Snapshots: **92**
Cadence: target **15m** · median **42.8187m** · max **275.0846m** · excessive gaps **30** · healthy **no** · scope **active-market within-session** · closed snapshots ignored **39** · outside-window snapshots ignored **5** · cross-session gaps ignored **3**
...
Snapshot cadence is incomplete (30 active-market within-session gap(s) above 24 minutes). Repair measurement coverage before interpreting model performance.
